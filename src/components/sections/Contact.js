      ...
      <div className="boxes">
        ...
        <div>
          ...
          <div className="animated-layer fade-in-up-animation fadeInUp wow">
            ...
            <ul className="social">
              <li>
                <a href="https://github.com/mhmd-aashik">
              ...
              <li>
                <a href="https://www.instagram.com/mhmd_aashik/">
                  <i className="fa-brands fa-instagram" />
                </a>
              </li>
              <li>
                <a href="https://web.facebook.com/profile.php?id=100092398624355">
